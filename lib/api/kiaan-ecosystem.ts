...
export const KIAAN_TOOLS: KiaanTool[] = [
  ...
  },
  {
    ...
    category: 'emotional',
    endpoint: '/api/emotional-reset/start',
  ...
  },
  {
    ...
    category: 'relational',
    endpoint: '/api/sambandh-dharma/gita-guidance',
  ...
  },
  {
    ...
    category: 'relational',
    endpoint: '/api/sambandh-dharma-engine/clarity',
    route: '/sambandh-dharma-engine',
    icon: '🎯',
  ...
  },
  {
    ...
    category: 'reflective',
    endpoint: '/api/karmic-tree/progress',
