    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Outer golden ring */}
          <motion.div
            className="absolute w-[600px] h-[600px] rounded-full border-4 border-amber-400/30"
            animate={{ rotate: 360 }}
            transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
          />
          {/* Middle ring */}
          <motion.div
            className="absolute w-[450px] h-[450px] rounded-full border-2 border-amber-300/40"
            animate={{ rotate: -360 }}
            transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
          />
          {/* Inner chakra */}
          <motion.div
            className="absolute w-[300px] h-[300px] rounded-full border-8 border-amber-500/60"
            animate={{
              rotate: 360,
              boxShadow: [
          ...
          >
            ...
            {[...Array(8)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute top-1/2 left-1/2 w-1 h-[150px] bg-gradient-to-t from-amber-500 to-amber-300 origin-bottom"
          ...
          {/* Center */}
          <motion.div
            className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-amber-400 to-orange-500"
            animate={{
              scale: [1, 1.2, 1],
              boxShadow: [
        ...
        >
          {[...Array(12)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute top-1/2 left-1/2 w-1 h-[50vh] bg-gradient-to-t from-amber-400/40 to-transparent origin-bottom"
        ...
        {/* Content Card */}
        <motion.div
          className="relative z-10 w-full max-w-md mx-4 bg-gradient-to-br from-amber-950/95 to-orange-950/95 backdrop-blur-xl rounded-3xl border border-amber-500/30 shadow-2xl overflow-hidden"
          initial={{ scale: 0.9, opacity: 0, y: 20 }}
          animate={{ scale: 1, opacity: 1, y: 0 }}
          transition={{ delay: 0.5 }}
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 px-6 py-4 border-b border-amber-500/20 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-amber-100 font-semibold">Divine Protection Shield</h2>
                <p className="text-amber-200/60 text-xs">Sudarshana Chakra Activated</p>
              </div>
            </div>
            <button
              onClick={closeShield}
            ...
            <AnimatePresence mode="wait">
              ...
              {phase === 'activating' && (
                ...
                >
                  ...
                  <p className="text-amber-200/80 mt-4">Activating divine protection...</p>
                </motion.div>
              )}
              ...
              {phase === 'protection' && (
                ...
                >
                  ...
                  <div className="text-center mb-6">
                    ...
                    <p className="text-xl text-amber-100 font-light mb-2">
                  ...
                  <div className="flex gap-3">
                    <motion.button
                      ...
                      className="flex-1 py-3 bg-gradient-to-r from-amber-500/30 to-orange-500/30 hover:from-amber-500/40 hover:to-orange-500/40 border border-amber-500/30 rounded-xl text-amber-100 transition-all"
                    ...
                    <motion.button
                      onClick={closeShield}
                      className="flex-1 py-3 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 rounded-xl text-amber-200/80 transition-all"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      I Feel Protected
              ...
              {phase === 'grounding' && (
                ...
                >
                  <div className="mb-6">
                    ...
                    <p className="text-amber-100 text-lg font-light mb-2">
                    ...
                    {GROUNDING_STEPS.map((_, i) => (
                      <motion.div
                        ...
                        className={`w-2 h-2 rounded-full transition-colors duration-300 ${
                          i <= groundingStep ? 'bg-amber-400' : 'bg-amber-400/20'
                        }`}
              ...
              {phase === 'complete' && (
                ...
                >
                  <motion.div
                    className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-amber-400/30 to-green-400/30 flex items-center justify-center"
                    animate={{
                      boxShadow: [
                  ...
                  <motion.button
                    onClick={closeShield}
                    className="w-full py-3 bg-gradient-to-r from-amber-500/30 to-green-500/30 hover:from-amber-500/40 hover:to-green-500/40 border border-amber-500/30 rounded-xl text-amber-100 transition-all"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    Continue with Peace
