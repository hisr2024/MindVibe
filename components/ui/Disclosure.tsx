...
interface DisclosureSingleProps {
  items: {
    id: string
    title: string
    preview?: string
...
interface DisclosureMultipleProps {
  items: {
    id: string
    title: string
    preview?: string
...
type DisclosureProps = DisclosureSingleProps | DisclosureMultipleProps
...
function AccordionItem({ item }: { item: { id: string; title: string; preview?: string; content: React.ReactNode } }) {
  return (
