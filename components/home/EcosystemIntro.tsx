...
export function EcosystemIntro() {
  ...
  return (
    <section className="space-y-6 rounded-3xl border border-[#d4a44c]/15 bg-gradient-to-br from-[#0d0d0f]/90 via-[#050714]/80 to-[#120a07]/90 p-6 shadow-[0_30px_120px_rgba(212,164,76,0.18)] backdrop-blur md:p-8">
      {/* Header */}
