...
export function DesktopNav({ className = '' }: DesktopNavProps) {
  ...
  const mainNavLinks = useMemo(() => [
    ...
    { href: '/deep-insights', label: t('navigation.features.deepInsights', 'Deep Insights') },
    { href: '/ardha', label: t('navigation.features.ardha', 'Ardha') },
    { href: '/viyog', label: t('navigation.features.viyog', 'Viyoga') },
