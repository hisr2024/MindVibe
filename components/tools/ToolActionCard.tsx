...
export function ToolActionCard({
  ...
  const baseStyles = `group rounded-2xl border border-orange-500/20 bg-gradient-to-br ${gradient} p-5 shadow-[0_15px_60px_rgba(255,115,39,0.12)] transition hover:border-orange-400/30 focus:outline-none focus:ring-2 focus:ring-orange-400/50 focus:ring-offset-2 focus:ring-offset-slate-900 ${className}`
