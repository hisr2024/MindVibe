...
class ErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[200px] p-6 bg-red-500/10 rounded-2xl border border-red-500/30">
          ...
          <button
            ...
            className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-400 rounded-xl text-sm font-medium transition-colors"
          >
            Try Again
          </button>
        </div>
