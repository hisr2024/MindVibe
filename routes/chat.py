...
class ChatMessage(BaseModel):
    ...
    include_sanskrit: bool = Field(default=False, description="Include Sanskrit verses in response")
...
class ChatResponse(BaseModel):
    ...
    language: str
    conversation_length: int = Field(..., description="Number of messages in this conversation")
...
async def chatbot_health():
    ...
    openai_configured = bool(os.getenv("OPENAI_API_KEY") and os.getenv("OPENAI_API_KEY") != "your-api-key-here")
