...
const MOBILE_ROUTE_MAP: Record<string, string> = {
  ...
  '/tools': '/m/tools',
  '/sadhana': '/m/sadhana',
  '/kiaan-vibe': '/m/kiaan-vibe',
  '/companion': '/m/companion',
  '/tools/viyog': '/m/viyog',
  '/viyog': '/m/viyog',
  '/tools/ardha': '/m/ardha',
  '/ardha': '/m/ardha',
  '/tools/emotional-reset': '/m/emotional-reset',
  '/emotional-reset': '/m/emotional-reset',
  '/tools/karma-reset': '/m/karma-reset',
  '/tools/sambandh-dharma': '/m/sambandh-dharma',
  '/sambandh-dharma': '/m/sambandh-dharma',
  '/tools/karma-footprint': '/m/karma-footprint',
  '/karma-footprint': '/m/karma-footprint',
  '/tools/karmic-tree': '/m/karmic-tree',
  '/karmic-tree': '/m/karmic-tree',
  '/deep-insights': '/m/deep-insights',
  '/community': '/m/community',
  '/wisdom-rooms': '/m/wisdom-rooms',
