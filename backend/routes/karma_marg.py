"""
Karma Marg (Karma Journey) API Routes - REST API for Journey Management.
...
from backend.services.karma_marg import (
    KarmaMargService,
    EnemyProgressTracker,
    ModernExamplesDB,
)
from backend.services.karma_marg.karma_marg_service import (
    KarmaMargError,
...
from backend.services.karma_marg.template_generator import ENEMY_METADATA, EnemyType
from backend.services.notification_dispatcher import dispatch_notification

logger = logging.getLogger(__name__)

router = APIRouter(tags=["Karma Marg (Karma Journey)"])
...
# =============================================================================
# The Karma Marg (Karma Journey) already stores teaching, verses, practice, etc. on every
...
def _step_to_response(
    ...
    Args:
        step: Domain step object from KarmaMargService.
...
async def list_templates(
    ...
    service: KarmaMargService = Depends(get_journey_service),
):
    """
    ...
    try:
        ...
        try:
            ...
            if _settings.ENABLE_AI_SAKHA_RESPONSE:
                from backend.services.karma_marg.sakha_wisdom_generator import (
                    SakhaContext,
                    generate_ai_sakha,
                )
