...
def _get_fallback_response(
    ...
    if analysis_mode == AnalysisMode.QUANTUM_DIVE:
        sections = {
            ...
            "quantum_reframing": f"THE QUANTUM SHIFT: From \"I am this problem\" to \"I am the awareness witnessing this challenge.\" Your essence - \"atman\" - remains untouched by any circumstance. What if this thought were a cloud, and you were the vast sky?",
        ...
        sections = {
            ...
            "comprehensive_reframe": f"THE REFRAME: You are not this thought - you are the awareness that notices it. \"Sakshi bhava\" - witness consciousness. The very fact that you can observe this thought proves you are separate from it. You are the vast sky; this thought is a passing cloud.",
