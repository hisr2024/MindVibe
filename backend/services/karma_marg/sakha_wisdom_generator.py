...
This module sits between the karma-marg route and the shared provider
...
deterministic _build_sakha_response() in routes/karma_marg.py:
...
def _get_examples_db() -> Any:
    ...
    from backend.services.karma_marg.modern_examples import ModernExamplesDB
