"""Sambandh Dharma (Relationship Compass) Wisdom Synthesizer - OpenAI-powered secular guidance.
...
Usage:
    from backend.services.sambandh_dharma_synthesizer import WisdomSynthesizer
...
SYNTHESIS_MODEL = os.getenv("SAMBANDH_DHARMA_MODEL", "gpt-4o-mini")
...
WISDOM_SYNTHESIS_SYSTEM_PROMPT = """You are Sambandh Dharma (Relationship Compass) — an emotionally intelligent, deeply feeling relationship guide.
...
class WisdomSynthesizer:
    ...
    def _build_fallback(
        ...
        """
        from backend.services.sambandh_dharma_engine import build_fallback_response
