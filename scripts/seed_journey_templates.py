...
KRODHA_STEPS = [
    ...
    {"day_index": 4, "step_title": "The Anger Within Anger",
     "teaching_hint": "Beneath anger often lies hurt, fear, or unmet needs. Look deeper.",
     ...
     "verse_selector": {"tags": ["self-knowledge", "wisdom", "introspection"], "max_verses": 2}},
    {"day_index": 5, "step_title": "Righteous vs Destructive Anger",
     "teaching_hint": "Not all anger is harmful. Krishna showed righteous anger. Discern the difference.",
     ...
     "verse_selector": {"tags": ["dharma", "righteousness", "discrimination"], "max_verses": 2}},
    {"day_index": 6, "step_title": "The Witness of Anger",
     "teaching_hint": "Practice being the witness. Observe anger without becoming it.",
     ...
     "verse_selector": {"tags": ["witness", "consciousness", "detachment"], "max_verses": 2}},
    {"day_index": 7, "step_title": "Week One Integration",
     "teaching_hint": "Reflect on your journey so far. What patterns have emerged?",
     ...
     "verse_selector": {"tags": ["wisdom", "self-knowledge", "reflection"], "max_verses": 2}},
    {"day_index": 8, "step_title": "The Body of Anger",
     "teaching_hint": "Anger lives in the body. Learn to recognize its physical signatures.",
     ...
     "verse_selector": {"tags": ["body", "awareness", "presence"], "max_verses": 2}},
    {"day_index": 9, "step_title": "Responding vs Reacting",
     "teaching_hint": "A reaction is automatic; a response is chosen. Build the gap between stimulus and response.",
     ...
     "verse_selector": {"tags": ["action", "restraint", "wisdom"], "max_verses": 2}},
    {"day_index": 10, "step_title": "Forgiveness as Freedom",
     ...
     "verse_selector": {"tags": ["forgiveness", "compassion", "liberation"], "max_verses": 2}},
    {"day_index": 11, "step_title": "Communicating Without Anger",
     "teaching_hint": "Learn to express needs clearly without the charge of anger.",
     ...
     "verse_selector": {"tags": ["communication", "truth", "non-violence"], "max_verses": 2}},
    {"day_index": 12, "step_title": "Transforming Anger to Strength",
     "teaching_hint": "Anger's energy can be channeled into determination and righteous action.",
     ...
     "verse_selector": {"tags": ["strength", "action", "transformation"], "max_verses": 2}},
    {"day_index": 13, "step_title": "Cultivating Inner Peace",
     "teaching_hint": "Peace is not the absence of triggers but the presence of equanimity.",
     ...
     "verse_selector": {"tags": ["peace", "equanimity", "serenity"], "max_verses": 2}},
    {"day_index": 14, "step_title": "The Mastery of Krodha",
     "teaching_hint": "You have walked the path. Now embody patient strength as your natural state.",
