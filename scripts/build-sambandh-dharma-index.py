#!/usr/bin/env python3
"""Build sqlite vector index for Sambandh Dharma (Relationship Compass) Gita RAG."""
...
INDEX_DIR = DATA_ROOT / "sambandh_dharma"
...
def main() -> None:
    ...
    print(f"Saved Sambandh Dharma (Relationship Compass) index to {INDEX_PATH}")
