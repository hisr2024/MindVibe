...
function EncryptedJournal() {
  ...
  const [cipherList, setCipherList] = useLocalState<EncryptedBlob[]>('mindvibe_journal_cipher', [])
  ...
  return (
    <section className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-8 space-y-6">
