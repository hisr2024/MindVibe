...
const insightTools = [
  {
    ...
    accent: 'from-[#d4a44c]/20 via-[#d4a44c]/15 to-rose-300/15',
    logo: <ArdhaLogo />,
  },
  {
    href: '/viyog',
...
function ArdhaLogo() {
  return (
    <div className="relative h-14 w-14" aria-hidden>
      <div className="absolute inset-0 animate-[spin_9s_linear_infinite] rounded-3xl bg-gradient-to-br from-[#e8b54a] via-[#d4a44c]/50 to-pink-400 opacity-60 blur" />
      <div className="absolute inset-[3px] rounded-[26px] bg-white/10 backdrop-blur" />
      <div className="relative flex h-full w-full items-center justify-center rounded-[28px] bg-gradient-to-br from-[#d4a44c]/90 via-[#d4a44c]/80 to-pink-500/80 shadow-[0_10px_45px_rgba(212,164,76,0.38)] ring-1 ring-white/30">
...
function RelationshipCompassLogo() {
  return (
    <div className="relative h-14 w-14" aria-hidden>
      ...
      <div className="absolute inset-[3px] rounded-[26px] bg-white/10 backdrop-blur" />
      <div className="relative flex h-full w-full items-center justify-center rounded-[28px] bg-gradient-to-br from-rose-500 via-[#d4a44c] to-[#e8b54a] shadow-[0_10px_45px_rgba(251,113,133,0.32)] ring-1 ring-white/30">
  ...
  return (
    <main className="mv-page relative min-h-screen p-4 md:p-8 pb-24">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-24 top-12 h-64 w-64 rounded-full bg-gradient-to-br from-[#d4a44c]/20 via-[#d4a44c]/10 to-transparent blur-3xl" />
        ...
        <section className="grid gap-4 md:grid-cols-3" aria-label="Deep Insights tools">
          {insightTools.map(tool => (
            <Link
              key={tool.href}
              href={tool.href}
              className="group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-white/5 bg-white/5 p-5 shadow-[0_18px_70px_rgba(212,164,76,0.14)] transition hover:-translate-y-1 hover:border-[#d4a44c]/40 hover:shadow-[#d4a44c]/20 focus:outline-none focus:ring-2 focus:ring-[#d4a44c]"
            >
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/70">
                      <span className="h-1.5 w-1.5 rounded-full bg-[#e8b54a] animate-pulse" aria-hidden />
                      Open
                    </span>
                  </div>
                  {tool.logo}
              ...
              <div className="relative mt-4 flex items-center gap-2 text-sm font-semibold text-[#e8b54a]">
                <span>Launch</span>
                <span aria-hidden>→</span>
              </div>
              <div className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-br from-[#d4a44c]/0 via-[#d4a44c]/0 to-[#d4a44c]/10 opacity-0 blur-2xl transition group-hover:opacity-100" />
            </Link>
          ))}
        </section>
      </div>
