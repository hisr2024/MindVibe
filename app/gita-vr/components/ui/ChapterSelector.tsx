/**
 * ChapterSelector — Chapter navigation overlay
 *
 * Displays all 18 Gita chapters as selectable cards in a grid.
 * Active chapter glows golden. Chapter 11 (Vishwaroop) has cosmic badge.
 * Regular DOM overlay (no Three.js Html wrapper).
 */
