/**
 * Unified Sambandh Dharma (Relationship Compass) API Route - Secular Wisdom Core + OpenAI.
 *
 * Proxies to the backend /api/sambandh-dharma/unified-clarity endpoint.
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/api/sambandh-dharma/unified-clarity`, {
        method: 'POST',
