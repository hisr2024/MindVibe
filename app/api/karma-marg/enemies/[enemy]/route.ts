/**
 * Karma Marg (Karma Journey) Enemy Detail API Proxy
 *
 * GET /api/karma-marg/enemies/[enemy] → Get details for a specific inner enemy
 */
...
export async function GET(
  ...
  try {
    const response = await fetchWithRetry(
      `${BACKEND_URL}/api/karma-marg/enemies/${encodeURIComponent(enemy)}`,
