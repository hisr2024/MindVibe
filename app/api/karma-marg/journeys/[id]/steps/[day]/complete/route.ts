 ...
 *
 * POST /api/karma-marg/journeys/[id]/steps/[day]/complete → Complete a step
 */
...
export async function POST(
  ...
  try {
    ...
    const response = await fetchWithRetry(
      `${BACKEND_URL}/api/karma-marg/journeys/${encodeURIComponent(id)}/steps/${encodeURIComponent(day)}/complete`,
      {
        method: 'POST',
