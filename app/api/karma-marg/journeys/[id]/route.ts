 ...
 *
 * GET  /api/karma-marg/journeys/[id] → Get journey details
 * DELETE /api/karma-marg/journeys/[id] → Abandon a journey
 */
...
export async function GET(
  ...
  try {
    const response = await fetchWithRetry(
      `${BACKEND_URL}/api/karma-marg/journeys/${encodeURIComponent(id)}`,
      {
        method: 'GET',
