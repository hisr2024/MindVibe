/**
 * Karma Marg (Karma Journey) Examples by Enemy API Proxy
 *
 * GET /api/karma-marg/examples/[enemy] → Get example journeys for a specific enemy
 */
...
export async function GET(
  ...
  try {
    const response = await fetchWithRetry(
      `${BACKEND_URL}/api/karma-marg/examples/${encodeURIComponent(enemy)}`,
