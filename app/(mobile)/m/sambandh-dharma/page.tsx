...
/**
 * Sacred Mobile Sambandh Dharma (Relationship Compass) Page — 6-Chamber Sacred Journey
 *
...
export default function MobileSambandhDharmaPage() {
  return (
    <MobileAppShell title="Sambandh Dharma (Relationship Compass)" showBack showTabBar={false}>
