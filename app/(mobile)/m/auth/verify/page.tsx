...
function VerifyContent() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center mt-6">
        {/* Email icon */}
        <div className="w-16 h-16 rounded-full bg-[rgba(27,79,187,0.15)] border border-[rgba(27,79,187,0.3)] flex items-center justify-center mb-5">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--sacred-krishna-glow)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
