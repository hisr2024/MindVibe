    ...
    <main className="mx-auto max-w-6xl space-y-10 px-4 pb-16">
      <section className="rounded-3xl border border-orange-500/15 bg-gradient-to-br from-[#0d0d10]/90 via-[#0b0b0f]/80 to-[#0f0a08]/90 p-8 shadow-[0_20px_80px_rgba(255,115,39,0.12)]">
        ...
        <p className="mt-4 max-w-3xl text-orange-100/80">
          MindVibe is a mental health companion that pairs gentle guidance with strong privacy. We prioritize accessible design,
          transparent communication, and features that encourage mindful progress without overwhelm.
        </p>
      </section>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="rounded-3xl border border-orange-500/15 bg-black/40 p-6">
          ...
          <p className="mt-2 text-orange-100/80">
            Help people slow down, reflect, and choose thoughtful responses. KIAAN powers calm conversation, while supportive
            tools like the Clarity Pause and Ardha Reframer keep agency with the user.
          </p>
        </div>
        <div className="rounded-3xl border border-orange-500/15 bg-black/40 p-6">
          <h3 className="text-lg font-semibold text-orange-50">Future vision</h3>
          <p className="mt-2 text-orange-100/80">
            We are designing dashboards, integrations with Python-backed insights, and progressive web app capabilities so your
            support space grows with you.
          </p>
        </div>
      </section>
    </main>
