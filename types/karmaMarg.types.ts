/**
 * Karma Marg (Karma Journey) Types - TypeScript definitions for the Six Enemies (Shadripu) Journey System.
 *
 ...
 *
 * NOTE: Types match backend response models in backend/routes/karma_marg.py
 */
