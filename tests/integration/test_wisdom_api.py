...
async def sample_verses(test_db: AsyncSession):
    ...
    verses_data = [
        ...
        },
        {
            ...
            "mental_health_applications": {
                "applications": ["emotional_regulation", "resilience_building", "stress_management"]
            }
        },
        {
            "verse_id": "6.35",
...
class TestWisdomVerseRetrieval:
    ...
    async def test_get_verse_by_id_with_sanskrit(self, test_client: AsyncClient, sample_verses):
        """Test retrieving a verse with Sanskrit included."""
        response = await test_client.get("/api/wisdom/verses/2.47?include_sanskrit=true")
    ...
    async def test_get_verse_by_id_hindi(self, test_client: AsyncClient, sample_verses):
        ...
        assert "तुम्हारा" in data["text"] or "सफलता" in data["text"] or len(data["text"]) > 0
    ...
    async def test_get_verse_invalid_language(self, test_client: AsyncClient, sample_verses):
...
class TestWisdomVerseList:
    ...
    async def test_list_verses_with_limit(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_list_verses_with_pagination(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_list_verses_by_theme(self, test_client: AsyncClient, sample_verses):
        ...
        response = await test_client.get("/api/wisdom/verses?theme=action_without_attachment")
    ...
    async def test_list_verses_by_application(self, test_client: AsyncClient, sample_verses):
        """Test filtering verses by mental health application."""
        response = await test_client.get("/api/wisdom/verses?application=anxiety_management")
...
class TestSemanticSearch:
    ...
    async def test_semantic_search_basic(self, test_client: AsyncClient, sample_verses):
        ...
        response = await test_client.post(
            "/api/wisdom/search",
            json={"query": "how to manage anxiety"}
        )
    ...
    async def test_semantic_search_with_relevance_scores(self, test_client: AsyncClient, sample_verses):
        """Test that search results include relevance scores."""
        response = await test_client.post(
            "/api/wisdom/search",
            json={"query": "stress and anxiety"}
        )
    ...
    async def test_semantic_search_with_limit(self, test_client: AsyncClient, sample_verses):
        """Test semantic search with custom limit."""
        response = await test_client.post(
            "/api/wisdom/search?limit=2",
            json={"query": "mental peace"}
        )
    ...
    async def test_semantic_search_with_theme_filter(self, test_client: AsyncClient, sample_verses):
        """Test semantic search with theme filtering."""
        response = await test_client.post(
            "/api/wisdom/search?theme=control_of_mind",
            json={"query": "mind control"}
        )
    ...
    async def test_semantic_search_with_application_filter(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_semantic_search_empty_query(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_semantic_search_short_query(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_semantic_search_hindi(self, test_client: AsyncClient, sample_verses):
        ...
        response = await test_client.post(
            "/api/wisdom/search?language=hindi",
            json={"query": "peace of mind"}
        )
    ...
    async def test_semantic_search_with_sanskrit(self, test_client: AsyncClient, sample_verses):
        """Test semantic search with Sanskrit included."""
        response = await test_client.post(
            "/api/wisdom/search?include_sanskrit=true",
            json={"query": "mental balance"}
        )
...
class TestWisdomQueryEndpoint:
    ...
    async def test_query_wisdom_basic(self, test_client: AsyncClient, sample_verses):
        ...
        with patch('routes.wisdom_guide.generate_wisdom_response',
    ...
    async def test_query_wisdom_short_query(self, test_client: AsyncClient, sample_verses):
...
class TestAPIValidation:
    ...
    async def test_invalid_limit_too_high(self, test_client: AsyncClient, sample_verses):
        """Test that limit above maximum is rejected."""
        response = await test_client.get("/api/wisdom/verses?limit=1000")
        
        assert response.status_code == 422  # Validation error
    
    async def test_invalid_limit_negative(self, test_client: AsyncClient, sample_verses):
        """Test that negative limit is rejected."""
        response = await test_client.get("/api/wisdom/verses?limit=-1")
        
        assert response.status_code == 422
    
    async def test_invalid_offset_negative(self, test_client: AsyncClient, sample_verses):
        """Test that negative offset is rejected."""
        response = await test_client.get("/api/wisdom/verses?offset=-1")
        
        assert response.status_code == 422
    
    async def test_search_limit_validation(self, test_client: AsyncClient, sample_verses):
        """Test search endpoint limit validation."""
        response = await test_client.post(
            "/api/wisdom/search?limit=100",
            json={"query": "test"}
        )
...
class TestAPIPagination:
    ...
    async def test_pagination_has_more_true(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_pagination_has_more_false(self, test_client: AsyncClient, sample_verses):
    ...
    async def test_pagination_offset_beyond_total(self, test_client: AsyncClient, sample_verses):
