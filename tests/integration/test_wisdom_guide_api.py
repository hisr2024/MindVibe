...
class TestWisdomQueryEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_query_wisdom_success(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_query_wisdom_with_sanskrit(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_query_wisdom_hindi_language(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_query_wisdom_no_results(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_query_wisdom_invalid_language(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_query_wisdom_empty_query(self, test_client: AsyncClient, test_db: AsyncSession):
...
class TestThemesEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_list_themes_success(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_list_themes_empty(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_list_themes_duplicate_themes(self, test_client: AsyncClient, test_db: AsyncSession):
...
class TestGetVerseEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_verse_success(self, test_client: AsyncClient, test_db: AsyncSession):
        ...
        verse = WisdomVerse(
            ...
            mental_health_applications={"applications": ["addiction", "impulse_control"]}
        )
        test_db.add(verse)
        await test_db.commit()
    ...
    @pytest.mark.asyncio
    async def test_get_verse_with_language_hindi(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_get_verse_with_sanskrit_included(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_get_verse_not_found(self, test_client: AsyncClient, test_db: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_get_verse_invalid_language(self, test_client: AsyncClient, test_db: AsyncSession):
