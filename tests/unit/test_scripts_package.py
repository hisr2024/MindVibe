...
def test_scripts_can_be_imported():
    ...
    for script_name in expected_scripts:
        ...
        assert script_path.exists(), f"Script {script_name} not found in scripts package"
...
def test_scripts_have_docstrings():
    ...
    for script_name in scripts_to_check:
        ...
        assert 'Can be run as:' in content or 'Usage:' in content, \
...
def test_scripts_have_proper_imports():
    ...
    for script_name in scripts_to_check:
        ...
        assert 'sys.path.insert' in content or 'Path(__file__).parent.parent' in content, \
...
def test_seed_scripts_have_database_imports():
    ...
    for script_name in seed_scripts:
        ...
        assert 'asyncio' in content or 'async def' in content, \
...
def test_verify_script_has_verification_logic():
    ...
    assert 'Testing' in content or 'Verification' in content, \
...
def test_generate_key_script_has_crypto_imports():
    ...
    assert 'from cryptography' in content or 'import cryptography' in content, \
