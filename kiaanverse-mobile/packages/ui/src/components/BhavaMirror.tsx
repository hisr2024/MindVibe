/**
 * BhavaMirror — Circular SVG mood selector with 8 spiritual states.
 *
...
/** Props for the BhavaMirror component. */
export interface BhavaMirrorProps {
...
function BhavaMirrorInner({
  selectedMood,
  onMoodSelect,
  size = 280,
  testID,
}: BhavaMirrorProps): React.JSX.Element {
...
export const BhavaMirror = React.memo(BhavaMirrorInner);
