 ...
 *   /wisdom/theme/[themeId]          — Curated verse list for one theme
 *                                      (Inner Peace · Courage · Wisdom · Devotion
 *                                       · Right Action · Letting Go)
 *   /wisdom/verse/[chapter]/[verse]  — Read More: full verse + voice + Listen
 *
 * Every screen renders its own DivineScreenWrapper background so the
